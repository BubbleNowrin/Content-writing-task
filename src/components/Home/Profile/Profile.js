...
import img from "../../../Assets/images/6-17 ariana grande.webp"
                            ...
                            <div className="flex flex-col space-y-4">
                                ...
                                <div className="space-y-1">
                                    <span className="flex items-center space-x-2">
                                        <SlCalender className="w-4 h-4"></SlCalender>
                                        <span className="">23/04/1998</span>
                                    </span>
                                    <span className="flex items-center space-x-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-label="Email address" className="w-4 h-4">
                                            <path fill="currentColor" d="M274.6,25.623a32.006,32.006,0,0,0-37.2,0L16,183.766V496H496V183.766ZM464,402.693,339.97,322.96,464,226.492ZM256,51.662,454.429,193.4,311.434,304.615,256,268.979l-55.434,35.636L57.571,193.4ZM48,226.492,172.03,322.96,48,402.693ZM464,464H48V440.735L256,307.021,464,440.735Z"></path>
                                        </svg>
                                        <span className="">nowrin.mim@company.com</span>
                                    </span>
                                    <span className="flex items-center space-x-2">
                        ...
                        <div >
                            <div className="h-full p-3 space-y-2 w-60 drawer-side ">
                                ...
                                <div className="flex items-center p-2 space-x-4">
                                    ...
                                    <div>
                                        <h2 className="text-lg font-semibold text-red-600">Nowrin Mim</h2>
                                        <span className="flex items-center space-x-1">
                                            <a rel="noopener noreferrer" href="#profile" className="text-xs hover:underline ">View profile</a>
                                        </span>
                                    </div>
                                </div>
